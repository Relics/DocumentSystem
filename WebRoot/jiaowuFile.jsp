				...
				<tr>
					...
					<td align="center">
						...
						<s:else>
							...
							<s:iterator value="#request.jiaowuFile" id="jiaowuFile">
								<tr>
									<td align="center">
										<s:property value="#jiaowuFile.fileName" />
									</td>
									<td align="center">
										<s:date name="#jiaowuFile.modifiedDate" format="yyyy-MM-dd" />
									</td>
									<td align="center">
										<s:property value="#jiaowuFile.ownPeopleId" />
									</td>
										<td align="center">
						<s:property value="#jiaowuFile.filePath" />
					</td>
									<td align="center">
										<s:property value="#jiaowuFile.kind" />
									</td>
									<td align="center">
										<s:property value="#jiaowuFile.size" />
									</td>
									<td align="center">
										<a
											href="download.action?file1.fileId=<s:property value="#jiaowuFile.fileId"/>"
											class="ico dcl">下载</a>
									</td>
										<td align="center">
										<a
											href="viewFile.action?file1.fileId=<s:property value="#jiaowuFile.fileId"/>"
											class="ico dcl">查看</a>
									</td>
								</tr>
							</s:iterator>
						...
						<div class="pagging">
							<div class="right">
								...
								<s:if test="#page.hasFirst">
									<a href="jiaowu.action?pageNow=1">首页</a>
								</s:if>
								<s:if test="#page.hasPre">
									<a
										href="jiaowu.action?pageNow=<s:property value="#page.pageNow-1"/>">上一页</a>
								</s:if>
								<s:if test="#page.hasNext">
									<a
										href="jiaowu.action?pageNow=<s:property value="#page.pageNow+1"/>">下一页</a>
								</s:if>
								<s:if test="#page.hasLast">
									<a
										href="jiaowu.action?pageNow=<s:property value="#page.totalPage"/>">尾页</a>
								</s:if>
							</div>
						</div>
						<!-- End Pagging -->
