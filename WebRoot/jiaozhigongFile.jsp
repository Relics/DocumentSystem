						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<s:iterator value="#request.allFolder" id="allFolder">
								<tr>
									...
									<td align="center">
										<s:property value="#jiaozhigongFile.size" />
									</td>
									<td align="center">
							...
							<s:iterator value="#request.jiaozhigongFile" id="jiaozhigongFile">
								<tr>
									<td align="center">
										<s:property value="#jiaozhigongFile.fileName" />
									</td>
									<td align="center">
										<s:date name="#jiaozhigongFile.modifiedDate"
											format="yyyy-MM-dd" />
									</td>
									<td align="center">
										<s:property value="#jiaozhigongFile.ownPeopleId" />
									</td>
									<td align="center">
										<s:property value="#jiaozhigongFile.filePath" />
									</td>
									<td align="center">
										<s:property value="#jiaozhigongFile.kind" />
									</td>
									<td align="center">
										<s:property value="#jiaozhigongFile.size" />
									</td>
									<td align="center">
										<a
											href="download.action?file1.fileId=<s:property value="#jiaozhigongFile.fileId"/>"
											class="ico dcl">下载</a>
									</td>
									<td align="center">
										<a
											href="viewFile.action?file1.fileId=<s:property value="#jiaozhigongFile.fileId"/>"
											class="ico dcl">查看</a>
									</td>
								</tr>
							</s:iterator>
						...
						<div class="pagging">
							<div class="right">
								...
								<s:if test="#page.hasFirst">
									<a href="jiaozhigong.action?pageNow=1">首页</a>
								</s:if>
								<s:if test="#page.hasPre">
									<a
										href="jiaozhigong.action?pageNow=<s:property value="#page.pageNow-1"/>">上一页</a>
								</s:if>
								<s:if test="#page.hasNext">
									<a
										href="jiaozhigong.action?pageNow=<s:property value="#page.pageNow+1"/>">下一页</a>
								</s:if>
								<s:if test="#page.hasLast">
									<a
										href="jiaozhigong.action?pageNow=<s:property value="#page.totalPage"/>">尾页</a>
								</s:if>
							</div>
						</div>
						<!-- End Pagging -->
