										...
										<tr>
											<form action="addUser.action" method="post">
												<input type="submit" class=" add-button" value="添加用户"
													style="width: 100px; height: 26; text-align: center; border: 0" />
											</form>
										</tr>
									</table>
								</div>
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<s:iterator value="#request.searchList" id="searchList">
								<tr>
									<td align="center">
										<s:property value="#searchList.peopleId" />
									</td>
									<td align="center">
										<s:property value="#searchList.groupNo" />
									</td>
									<td align="center">
										<s:property value="#searchList.peopleName" />
									</td>
									<td align="center">
										<s:property value="#searchList.departmentNo" />
									</td>
									<td align="center">
										<s:property value="#searchList.position" />
									</td>
									<td align="center">
										<a
											href="check.action?people.peopleId=<s:property value="#searchList.peopleId"/>"
											class="ico dcl">查看</a>
									</td>
									<td align="center">
										<a
											href="edit.action?people1.peopleId=<s:property value="#searchList.peopleId"/>"
											class="ico dcl">修改</a>
									</td>
									<td align="center">
										<a
											href="delete.action?people2.peopleId=<s:property value="#searchList.peopleId"/>"
											class="ico dcl">删除</a>
									</td>
								</tr>
							</s:iterator>
