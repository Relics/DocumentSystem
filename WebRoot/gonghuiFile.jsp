						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<s:iterator value="#request.allFolder" id="allFolder">
								<tr>
									...
									<td align="center">
										<s:property value="#gonghuiFile.size" />
									</td>
									<td align="center">
										<s:if test="#allFolder.kind=='文件夹'">
											<a
												href="enterFold1.action?file1.fileId=<s:property value="#allFolder.fileId"/>" class="ico dcl">进入</a>
										</s:if>
										<s:else>
											<a
												href="download.action?file1.fileId=<s:property value="#allFolder.fileId"/>" class="ico dcl">下载</a>
										</s:else>
							...
							<s:iterator value="#request.gonghuiFile" id="gonghuiFile">
								<tr>
									<td align="center">
										<s:property value="#gonghuiFile.fileName" />
									</td>
									<td align="center">
										<s:date name="#gonghuiFile.modifiedDate" format="yyyy-MM-dd" />
									</td>
									<td align="center">
										<s:property value="#gonghuiFile.ownPeopleId" />
									</td>
									<td align="center">
										<s:property value="#gonghuiFile.filePath" />
									</td>
									<td align="center">
										<s:property value="#gonghuiFile.kind" />
									</td>
									<td align="center">
										<s:property value="#gonghuiFile.size" />
									</td>
									<td align="center">
										<a
											href="download.action?file1.fileId=<s:property value="#gonghuiFile.fileId"/>"
											class="ico dcl">下载</a>
									</td>
										<td align="center">
										<a
											href="viewFile.action?file1.fileId=<s:property value="#gonghuiFile.fileId"/>"
											class="ico dcl">查看</a>
									</td>
								</tr>
							</s:iterator>
						...
						<div class="pagging">
							<div class="right">
								...
								<s:if test="#page.hasFirst">
									<a href="gonghui.action?pageNow=1">首页</a>
								</s:if>
								<s:if test="#page.hasPre">
									<a
										href="gonghui.action?pageNow=<s:property value="#page.pageNow-1"/>">上一页</a>
								</s:if>
								<s:if test="#page.hasNext">
									<a
										href="gonghui.action?pageNow=<s:property value="#page.pageNow+1"/>">下一页</a>
								</s:if>
								<s:if test="#page.hasLast">
									<a
										href="gonghui.action?pageNow=<s:property value="#page.totalPage"/>">尾页</a>
								</s:if>
							</div>
						</div>
						<!-- End Pagging -->
